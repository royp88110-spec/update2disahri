...
async function findAvailablePort(startPort) {
  ...
  throw new Error(`No available Metro port found between ${startPort} and ${startPort + 19}`);
}
...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  metroPort = await findAvailablePort(Number(process.env.EXPO_BUILD_PORT || 8081));
